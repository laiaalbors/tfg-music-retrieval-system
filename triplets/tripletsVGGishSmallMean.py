...
import torch
import pandas as pd
from datasets import TripletVGGishMean
...
#-------------------------------------------------#
triplet_train_dataset = TripletVGGishMean(partition['train'], labels, train=True) # Returns triplets of arrays
...
improve = False
if pth.isfile("./experimentsVGGishSmallMean/exp-"+str(experiment)+"/modelVGGishSmallMean-"+str(experiment)+".pt"):
...
#-------------------------------------------------#
if improve:
    torch.save(model.state_dict(), "./experimentsVGGishSmallMean/exp-"+str(experiment)+"/modelVGGishSmallMean2-"+str(experiment)+".pt")
else:
    torch.save(model.state_dict(), "./experimentsVGGishSmallMean/exp-"+str(experiment)+"/modelVGGishSmallMean-"+str(experiment)+".pt")
