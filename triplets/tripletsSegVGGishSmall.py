...
model.load_state_dict(torch.load("./experimentsVGGishSmall/exp-"+str(experiment)+"/modelVGGishSmall-"+str(experiment)+".pt"))
if cuda:
    model.cuda()
...
#-------------------------------------------------#
torch.save(model.state_dict(), "./experimentsVGGishSmall/exp-"+str(experiment)+"/modelSegVGGishSmall-"+str(experiment)+".pt")
