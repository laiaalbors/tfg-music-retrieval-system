...
path = "./experimentsVGGishSmall/exp-" + str(experiment) + "/"
...
if pth.isfile("./experimentsVGGishSmall/exp-"+str(experiment)+"/modelSegVGGishSmall-"+str(experiment)+".pt"):
    model.load_state_dict(torch.load("./experimentsVGGishSmall/exp-"+str(experiment)+"/modelSegVGGishSmall-"+str(experiment)+".pt"))
else:
...
#-------------------------------------------------#
torch.save(model.state_dict(), "./experimentsVGGishSmall/exp-"+str(experiment)+"/modelSegVGGishSmallDTW-"+str(experiment)+".pt")
print("Model guardat.")
