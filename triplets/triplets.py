...
#-------------------------------------------------#
triplet_train_dataset = Triplet(partition['train'], labels, train=True) # Returns triplets of arrays
triplet_valid_dataset = Triplet(partition['validation'], labels, train=False)
...
improve = False
if pth.isfile("./experimentsBig/exp-"+str(experiment)+"/modelBig-"+str(experiment)+".pt"):
...
#-------------------------------------------------#
if improve:
    torch.save(model.state_dict(), "./experimentsBig/exp-"+str(experiment)+"/modelBig2-"+str(experiment)+".pt")
else:
    torch.save(model.state_dict(), "./experimentsBig/exp-"+str(experiment)+"/modelBig-"+str(experiment)+".pt")
