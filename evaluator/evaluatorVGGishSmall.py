...
output_dim = int(arg[3])
kernel_size = int(arg[4])
embedding_size = int(arg[5])
experiment = int(arg[6])
improve = bool(int(arg[7]))
print("----------------")
print("PARAMETERS:")
print("k =", k)
...
#-------------------------------------------------#
train = pd.read_csv("../vggishBig/train/TRAIN3.csv", header=0)
...
def plot_embeddings(embeddings, targets, name, xlim=None, ylim=None):
    ...
    plt.legend(classes)
    if improve:
        plt.savefig("./experimentsVGGishSmallBig/exp-"+str(experiment)+'/'+name+"VGGishSmall2-"+str(experiment)+'.png')
    else:
        plt.savefig("./experimentsVGGishSmallBig/exp-"+str(experiment)+'/'+name+"VGGishSmall-"+str(experiment)+'.png')
...
if improve:
    ...
    model.load_state_dict(torch.load("./experimentsVGGishSmallBig/exp-"+str(experiment)+"/modelVGGishSmallBig2-"+str(experiment)+".pt"))
else:
