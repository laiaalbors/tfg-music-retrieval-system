...
def plot_embeddings(embeddings, targets, name, xlim=None, ylim=None):
    ...
    plt.legend(classes)
    if improve:
        plt.savefig("./experimentsVGGishSmallFT/exp-"+str(experiment)+'/'+name+"VGGishFT2-"+str(experiment)+'.png')
    else:
        plt.savefig("./experimentsVGGishSmallFT/exp-"+str(experiment)+'/'+name+"VGGishFT-"+str(experiment)+'.png')
...
if improve:
    ...
    model.load_state_dict(torch.load("./experimentsVGGishSmallFT/exp-"+str(experiment)+"/modelVGGishSmallFT2-"+str(experiment)+".pt", map_location=torch.device('cpu')))
else:
    model.load_state_dict(torch.load("./experimentsVGGishSmallFT/exp-"+str(experiment)+"/modelVGGishSmallFT-"+str(experiment)+".pt", map_location=torch.device('cpu')))
