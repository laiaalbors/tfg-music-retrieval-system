...
def plot_embeddings(embeddings, targets, name, xlim=None, ylim=None):
    ...
    plt.legend(classes)
    plt.savefig("./experimentsVGGishSmall/exp-"+str(experiment)+'/'+name+"SegVGGishSmallDTW-"+str(experiment)+'.png')
...
model.load_state_dict(torch.load("./experimentsVGGishSmall/exp-"+str(experiment)+"/modelSegVGGishSmallDTW-"+str(experiment)+".pt", map_location=torch.device('cpu')))
